...
Copyright © 2011, 2014-2018 roger21@free.fr
...
// historique :
// 3.6.0 (05/08/2019) :
// - Ajout de la gestion du MPStorage
// 3.5.2 (28/11/2018) :
  ...
  if(root) {
    ...
    function displayBlackListManagement(event) {
      ...
      for(let item of LocalMPStorage.blacklist.list) {
        ...
        trRemove.setAttribute("title", "Enlever " + item.pseudo + " de la liste noire");
        let tdRemovePseudo = document.createElement("td");
        tdRemovePseudo.style.verticalAlign = "bottom";
        tdRemovePseudo.appendChild(document.createTextNode(item.pseudo));
        ...
        inputRemove.dataset.pseudo = item.pseudo;
